...
if(Meteor.isClient){
  ...
  Router.onRun( function () {
    ...
    Session.set('collaboratorSlug', null);
...
PostsListController = FastRender.RouteController.extend({
  ...
  onBeforeAction: function () {
    ...
    this._terms = {
      ...
      collaboration: this.params.slug
    };
    ...
    console.log("298 subscribe('postsList'", this._terms);
    this.postsListSub = coreSubscriptions.subscribe('postsList', this._terms);
    // this.postsListSub = coreSubscriptions.subscribe('postsList');
    return [
      this.postsListSub,
...
PostsDigestController = FastRender.RouteController.extend({
  ...
  waitOn: function() {
    ...
    console.log("370 subscribe postsList", this._terms);
    return [
      coreSubscriptions.subscribe('postsList', terms),
      // coreSubscriptions.subscribe('postsList'),
